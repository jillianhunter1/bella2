...
$$
\frac{op \in \{<, \text{<=}, >, \text{>=}\} \quad m \vdash e_1 \Downarrow \mathsf{Num}\;x \quad m \vdash e_2 \Downarrow \mathsf{Num}\;y}{m \vdash [\![\, e_1\;op\;e_2 \,]\!] \Downarrow \mathsf{Bool}\;(op(x,y))}
$$
...
$$
\frac{m \vdash e_1 \Downarrow v \quad \text{isFalsy}(v)}{m \vdash [\![\, e_1 \text{ \&\& } e_2 \,]\!] \Downarrow v}
$$

$$
\frac{m \vdash e_1 \Downarrow v \quad \neg\text{isFalsy}(v) \quad m \vdash e_2 \Downarrow v_2}{m \vdash [\![\, e_1 \text{ \&\& } e_2 \,]\!] \Downarrow v_2}
$$

$$
\frac{m \vdash e_1 \Downarrow v \quad \neg\text{isFalsy}(v)}{m \vdash [\![\, e_1 \text{ || } e_2 \,]\!] \Downarrow v}
$$

$$
\frac{m \vdash e_1 \Downarrow v \quad \text{isFalsy}(v) \quad m \vdash e_2 \Downarrow v_2}{m \vdash [\![\, e_1 \text{ || } e_2 \,]\!] \Downarrow v_2}
$$
...
$$
\frac{m \vdash e \Downarrow v \quad \neg\text{isFalsy}(v) \quad m \vdash e_1 \Downarrow v_1}{m \vdash [\![\, e \text{ ? } e_1 \text{ : } e_2 \,]\!] \Downarrow v_1}
$$

$$
\frac{m \vdash e \Downarrow v \quad \text{isFalsy}(v) \quad m \vdash e_2 \Downarrow v_2}{m \vdash [\![\, e \text{ ? } e_1 \text{ : } e_2 \,]\!] \Downarrow v_2}
$$
...
- $\mathcal{E}{[\![\, e_1 \text{ \&\& } e_2 \,]\!]} \, m = \text{let } v = \mathcal{E}{[\![\, e_1 \,]\!]} \, m \text{ in if } \text{isFalsy}(v) \text{ then } v \text{ else } \mathcal{E}{[\![\, e_2 \,]\!]} \, m$
- $\mathcal{E}{[\![\, e_1 \text{ || } e_2 \,]\!]} \, m = \text{let } v = \mathcal{E}{[\![\, e_1 \,]\!]} \, m \text{ in if } \text{isTruthy}(v) \text{ then } v \text{ else } \mathcal{E}{[\![\, e_2 \,]\!]} \, m$
- $\mathcal{E}{[\![\, e \text{ ? } e_1 \text{ : } e_2 \,]\!]} \, m = \text{if } \text{isTruthy}(\mathcal{E}{[\![\, e \,]\!]} \, m) \text{ then } \mathcal{E}{[\![\, e_1 \,]\!]} \, m \text{ else } \mathcal{E}{[\![\, e_2 \,]\!]} \, m$
